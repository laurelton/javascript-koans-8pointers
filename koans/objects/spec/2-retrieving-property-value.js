describe('Retrieving properties', function() {
    ...
    it('5 - should know guard operator &&', function() {
        ...
        expect(samurai && samurai.address && samurai.address.street).toBe(
            'Samurai Way'
        );
    ...
    it('6 - should know how to combine default and guard operators', function() {
        ...
        expect(
            (samurai && samurai.address && samurai.address.street) || 'N/A'
        ).toBe('Samurai Way');
        expect(
            (samurai2 && samurai2.address && samurai2.address.street) || 'N/A'
        ).toBe('N/A');
        expect(
            (samurai3 && samurai3.address && samurai3.address.street) || 'N/A'
        ).toBe('N/A');
    });
